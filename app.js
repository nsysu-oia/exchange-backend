...
const dlConfigRouter = require('./routes/dl-config')
...
const proofOfScholarshipRouter = require('./routes/applications/proof-of-scholarship')
const downloadLinksRouter = require('./routes/applications/download-links')
...
app.use('/', indexRouter)
app.use('/dl-config', dlConfigRouter)
...
app.use('/proof-of-scholarship', proofOfScholarshipRouter)
app.use('/download-links', downloadLinksRouter)
